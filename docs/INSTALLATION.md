...
npx agent-skills-cli add citadelcloud/claude-skills --agent codex

# Option 2: Direct installation script
git clone https://github.com/citadelcloud/claude-skills.git
cd claude-skills
...
clawhub install citadelcloud/claude-skills
...
```bash
npx agent-skills-cli add citadelcloud/claude-skills
```
...
The universal installer uses the [Agent Skills CLI](https://github.com/citadelcloud/agent-skills-cli) package to install skills across multiple agents simultaneously.
...
```bash
# Claude Code only
npx agent-skills-cli add citadelcloud/claude-skills --agent claude

# Cursor only
npx agent-skills-cli add citadelcloud/claude-skills --agent cursor

# VS Code/Copilot only
npx agent-skills-cli add citadelcloud/claude-skills --agent vscode

# Goose only
npx agent-skills-cli add citadelcloud/claude-skills --agent goose

# Project-specific installation (portable)
npx agent-skills-cli add citadelcloud/claude-skills --agent project
```
...
npx agent-skills-cli add citadelcloud/claude-skills --dry-run
```
...
```bash
# Content Creator
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/content-creator

# Demand Generation & Acquisition
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/marketing-demand-acquisition

# Product Marketing Strategy
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/marketing-strategy-pmm

# App Store Optimization
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/app-store-optimization

# Social Media Analyzer
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/social-media-analyzer
```
...
```bash
# CEO Advisor
npx agent-skills-cli add citadelcloud/claude-skills/c-level-advisor/ceo-advisor

# CTO Advisor
npx agent-skills-cli add citadelcloud/claude-skills/c-level-advisor/cto-advisor
```
...
npx agent-skills-cli add citadelcloud/claude-skills/product-team/product-manager-toolkit

# Agile Product Owner
npx agent-skills-cli add citadelcloud/claude-skills/product-team/agile-product-owner

# Product Strategist
npx agent-skills-cli add citadelcloud/claude-skills/product-team/product-strategist

# UX Researcher Designer
npx agent-skills-cli add citadelcloud/claude-skills/product-team/ux-researcher-designer

# UI Design System
npx agent-skills-cli add citadelcloud/claude-skills/product-team/ui-design-system
```
...
```bash
# Senior PM Expert
npx agent-skills-cli add citadelcloud/claude-skills/project-management/senior-pm

# Scrum Master Expert
npx agent-skills-cli add citadelcloud/claude-skills/project-management/scrum-master

# Atlassian Jira Expert
npx agent-skills-cli add citadelcloud/claude-skills/project-management/jira-expert

# Atlassian Confluence Expert
npx agent-skills-cli add citadelcloud/claude-skills/project-management/confluence-expert

# Atlassian Administrator
npx agent-skills-cli add citadelcloud/claude-skills/project-management/atlassian-admin

# Atlassian Template Creator
npx agent-skills-cli add citadelcloud/claude-skills/project-management/atlassian-templates
```
...
```bash
# Core Engineering
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-architect
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-frontend
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-backend
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-fullstack
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-qa
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-devops
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-secops
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/code-reviewer
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-security

# Cloud & Enterprise
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/aws-solution-architect
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/ms365-tenant-manager

# Development Tools
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/tdd-guide
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/tech-stack-evaluator

# AI/ML/Data
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-data-scientist
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-data-engineer
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-ml-engineer
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-prompt-engineer
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team/senior-computer-vision
```
...
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/regulatory-affairs-head
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/quality-manager-qmr
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/quality-manager-qms-iso13485

# Quality Processes
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/capa-officer
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/quality-documentation-manager
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/risk-management-specialist

# Security & Privacy
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/information-security-manager-iso27001
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/gdpr-dsgvo-expert

# Regional Compliance
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/mdr-745-specialist
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/fda-consultant-specialist

# Audit & Assessment
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/qms-audit-expert
npx agent-skills-cli add citadelcloud/claude-skills/ra-qm-team/isms-audit-expert
```
...
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/content-creator --agent claude

# Install same skills to Cursor (for developer working on content)
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/content-creator --agent cursor

# Install to VS Code (for SEO specialist)
npx agent-skills-cli add citadelcloud/claude-skills/marketing-skill/content-creator --agent vscode
```
...
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team --agent claude

# Same suite to Cursor
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team --agent cursor
```
...
npx agent-skills-cli add citadelcloud/claude-skills/engineering-team
...
```bash
# Check network
curl https://github.com/citadelcloud/claude-skills
...
rm -rf ~/.claude/skills/citadelcloud/claude-skills/

# Remove from Cursor
rm -rf .cursor/skills/citadelcloud/claude-skills/

# Remove from VS Code
rm -rf .github/skills/citadelcloud/claude-skills/

# Remove from Goose
rm -rf ~/.config/goose/skills/citadelcloud/claude-skills/
```
...
clawhub install citadelcloud/claude-skills/engineering-team/senior-frontend
```
...
# Preview before installing
npx agent-skills-cli add citadelcloud/claude-skills --agent codex --dry-run
```
...
- Review [Agent Skills CLI documentation](https://github.com/citadelcloud/agent-skills-cli)
- Open issue: https://github.com/citadelcloud/claude-skills/issues

**Feature Requests:**
- Submit via GitHub Issues with `enhancement` label

**General Questions:**
- Visit: https://citadelcloudmanagement.com

---

**Last Updated:** March 2026
**Skills Version:** 2.1.2 (205+ production skills across 9 domains)
**Universal Installer:** [Agent Skills CLI](https://github.com/citadelcloud/agent-skills-cli)
